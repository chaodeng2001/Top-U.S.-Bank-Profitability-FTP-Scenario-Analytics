...
The FTP and scenario outputs are public-data-based estimates. They do not replicate each bank's internal FTP curve, loan repricing schedule, hedge book, deposit segmentation, loan portfolio mix, management forecast, or regulatory stress-test model.

The purpose of the project is to build a transparent public-data framework for peer comparison, not to forecast actual bank earnings.
